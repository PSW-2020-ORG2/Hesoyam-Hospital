...
import { PatientMainPageComponent } from './main-page/patient-main-page/patient-main-page.component';
...
const routes: Routes = [
  ...
  {path: 'main-page', component: PatientMainPageComponent, canActivate: [RouteGuardService], data: { expectedRole: 'Patient'}},
