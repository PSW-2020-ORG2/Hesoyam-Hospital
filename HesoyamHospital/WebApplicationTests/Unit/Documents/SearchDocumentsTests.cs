...
namespace WebApplicationTests.Unit.Documents
{
    public class SearchDocumentsTests
    {
        ...
        public void Search_only_reports_with_results()
        {
            ...
            SearchCriteria criteria = new SearchCriteria(true, false, new TimeInterval(DateTime.Now.AddDays(-10), DateTime.Now), "pera", "naziv1", "brufen", "nalaz");
        ...
        {
            DocumentService service = new DocumentService(CreateStubPrescriptionRepository(), CreateStubReportRepository());
            SearchCriteria criteria = new SearchCriteria(false, true, new TimeInterval(DateTime.Now.AddDays(-10), DateTime.Now), "pera", "naziv1", "brufen", "nalaz");
        ...
        {
            DocumentService service = new DocumentService(CreateStubPrescriptionRepository(), CreateStubReportRepository());
            SearchCriteria criteria = new SearchCriteria(true, true, new TimeInterval(DateTime.Now.AddDays(-10), DateTime.Now), "pera", "naziv1", "brufen", "nalaz");
        ...
        {
            DocumentService service = new DocumentService(CreateStubPrescriptionRepository(), CreateStubReportRepository());
            SearchCriteria criteria = new SearchCriteria(true, false, new TimeInterval(DateTime.Now.AddDays(-20), DateTime.Now.AddDays(-16)), "pera", "naziv1", "brufen", "nalaz");
        ...
        {
            DocumentService service = new DocumentService(CreateStubPrescriptionRepository(), CreateStubReportRepository());
            SearchCriteria criteria = new SearchCriteria(false, true, new TimeInterval(DateTime.Now.AddDays(-20), DateTime.Now.AddDays(-16)), "pera", "naziv1", "brufen", "nalaz");
        ...
        {
            DocumentService service = new DocumentService(CreateStubPrescriptionRepository(), CreateStubReportRepository());
            SearchCriteria criteria = new SearchCriteria(true, true, new TimeInterval(DateTime.Now.AddDays(-20), DateTime.Now.AddDays(-16)), "pera", "naziv1", "brufen", "nalaz");
        ...
        {
            DocumentService service = new DocumentService(CreateStubPrescriptionRepository(), CreateStubReportRepository());
            SearchCriteria criteria = new SearchCriteria(false, false, new TimeInterval(DateTime.Now.AddDays(-10), DateTime.Now), "pera", "naziv1", "brufen", "nalaz");
        ...
        private static IPrescriptionRepository CreateStubPrescriptionRepository()
        {
            ...
            p2.Diagnosis = new Diagnosis(0, "naziv2", "ab13");
        ...
        private static IReportRepository CreateStubReportRepository()
        {
            ...
            r2.Diagnosis = new Diagnosis(0, "naziv2", "ab13");
