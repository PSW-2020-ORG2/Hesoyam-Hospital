...
namespace WebApplication.Authentication
{
    public class SendEmail : ISendEmail
    {
        ...
        private MailMessage CreateEmail(MailAddress senderEmail, MailAddress patientEmail, long id)
        {
            ...
            mailMessage.Subject = "Activate account";
