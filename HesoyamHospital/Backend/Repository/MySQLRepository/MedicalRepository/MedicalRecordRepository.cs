...
namespace Backend.Repository.MySQLRepository.MedicalRepository
{
    public class MedicalRecordRepository : MySQLRepository<MedicalRecord, long>, IMedicalRecordRepository, IEagerRepository<MedicalRecord, long>
    {
        ...
        public MedicalRecordRepository(IMySQLStream<MedicalRecord> stream, ISequencer<long> sequencer, IPatientRepository patientRepository, IDiagnosisRepository diagnosisRepository, IAllergyRepository allergyRepository) : base(ENTITY_NAME, stream, sequencer, new LongIdGeneratorStrategy<MedicalRecord>())
        {
