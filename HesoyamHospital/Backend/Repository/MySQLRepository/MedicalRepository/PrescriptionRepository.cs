...
namespace Backend.Repository.MySQLRepository.MedicalRepository
{
    public class PrescriptionRepository : MySQLRepository<Prescription, long>, IPrescriptionRepository, IEagerRepository<Prescription, long>
    {
        ...
        public PrescriptionRepository(IMySQLStream<Prescription> stream, ISequencer<long> sequencer, IDoctorRepository doctorRepository, IMedicineRepository medicineRepository) : base(ENTITY_NAME, stream, sequencer, new LongIdGeneratorStrategy<Prescription>())
        {
